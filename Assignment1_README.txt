...
Available APIs:
  - POST createUserAccount
    - <domain name of our site>/createUserAccount/:fname/:lname/:dateOfBirth/:city
  ...
  - GET getAccount
    - <domain name of our site>/getAccount/:fname/:lname/:dateOfBirth/:city
  ...
  - DELETE deleteAccountById
    - <domain name of our site>/deleteAccountById/:person_num
    - Deletes user account from database.
  - GET allPersonNums
    - <domain name of our site>/allPersonNums
    - Gets all personal numbers of all users in DB for further use.
      Technical API. Not meant to be used in production.
  - PUT updateAccount
    - <domain name of our site>/updateAccount/:person_num/:lname
